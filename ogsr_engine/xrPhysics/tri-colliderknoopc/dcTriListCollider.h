...
private:
    IC void VxToGlClTriState(u32 v, std::span<const CDB::TRI> T_array);
    IC void SideToGlClTriState(u32 v0, u32 v1, std::span<const CDB::TRI> T_array);
    template <class Prim>
    ...
    int dSortedTriSphere(const dReal* /**v1**/, const dReal* /**v2**/, const dReal* triAx, const CDB::TRI* T, dReal dist, dxGeom* Sphere, dxGeom* Geometry,
                         int Flags, dContactGeom* Contacts, int skip);

    IC float dSphereProj(dxGeom* sphere, const dReal*)
    {
        XR_DEBUG_ASSERT(dGeomGetClass(sphere) == dSphereClass);
        return dGeomSphereGetRadius(sphere);
    }

    int dTriSphere(const dReal* v0, const dReal* v1, const dReal* v2, Triangle* T, dxGeom* Sphere, dxGeom* Geometry, int Flags, dContactGeom* Contacts, int);
    ...
    int dSortedTriBox(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, const CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, int flags,
    ...
    int dSortedTriCyl(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, const CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, int flags,
                      dContactGeom* contact, int skip);
    ...
    IC int CollidePlain(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, const CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, int flags,
                        dContactGeom* contact, int skip);
...
inline void dcTriListCollider::VxToGlClTriState(u32 v, std::span<const CDB::TRI> T_array)
{
    xr_vector<int>::iterator LI = I + 1;
    for (; E != LI; ++LI)
    {
        auto& verts = T_array[*LI].verts;
...
inline void dcTriListCollider::SideToGlClTriState(u32 v0, u32 v1, std::span<const CDB::TRI> T_array)
{
    xr_vector<int>::iterator LI = I + 1;
    for (; E != LI; ++LI)
    {
