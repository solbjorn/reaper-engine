...
private:
    struct State
    {
        ...
        constexpr void set_RS(u32 a, u32 b)
        {
            type = 0;
            v1 = a;
            v2 = b;
        ...
        constexpr void set_TSS(u32 a, u32 b, u32 c)
        {
            type = 1;
            v1 = a;
            v2 = b;
        ...
        constexpr void set_SAMP(u32 a, u32 b, u32 c)
        {
            type = 2;
            v1 = a;
            v2 = b;
...
public:
    ...
    void UpdateDesc(D3D_SAMPLER_DESC descArray[D3D_COMMONSHADER_SAMPLER_SLOT_COUNT], bool SamplerUsed[D3D_COMMONSHADER_SAMPLER_SLOT_COUNT],
