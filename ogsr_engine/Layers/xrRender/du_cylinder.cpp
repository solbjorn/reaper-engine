...
//---------------------------------------------------------------------------
const Fvector du_cylinder_vertices[DU_CYLINDER_NUMVERTEX] = {
...
const u16 du_cylinder_faces[DU_CYLINDER_NUMFACES * 3] = {
...
const u16 du_cylinder_lines[DU_CYLINDER_NUMLINES * 2] = {
    // tile
    0,
    1,
    //	 2,	   3,
