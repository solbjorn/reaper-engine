...
public:
    ...
    virtual void setGamma(f32 fGamma) = 0;
    virtual void setBrightness(f32 fGamma) = 0;
    virtual void setContrast(f32 fGamma) = 0;
    ...
    [[nodiscard]] virtual BOOL GetForceGPU_REF() = 0;
    [[nodiscard]] virtual u32 GetCacheStatPolys() = 0;
