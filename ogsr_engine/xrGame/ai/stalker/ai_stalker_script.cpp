    ...
    module(L)[(
        class_<CStalkerPlanner, CScriptActionPlanner>("stalker_ids")
            .enum_("properties")[(
                ...
                luabind::value("property_pure_enemy", StalkerDecisionSpace::eWorldPropertyPureEnemy), luabind::value("property_script", StalkerDecisionSpace::eWorldPropertyScript),
                luabind::value("property_enemy_wounded", StalkerDecisionSpace::eWorldPropertyEnemyWounded))]

            .enum_("action")[(
                luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead), luabind::value("action_dying", StalkerDecisionSpace::eWorldOperatorDying),
                ...
                luabind::value("action_find_ammo", StalkerDecisionSpace::eWorldOperatorFindAmmo), luabind::value("action_aim_enemy", StalkerDecisionSpace::eWorldOperatorAimEnemy),
                ...
                luabind::value("action_take_cover", StalkerDecisionSpace::eWorldOperatorTakeCover), luabind::value("action_look_out", StalkerDecisionSpace::eWorldOperatorLookOut),
            ...
            .enum_("sounds")[(luabind::value("sound_die", StalkerSpace::eStalkerSoundDie), luabind::value("sound_die_in_anomaly", StalkerSpace::eStalkerSoundDieInAnomaly),
