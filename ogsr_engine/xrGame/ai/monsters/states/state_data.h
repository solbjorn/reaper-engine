...
struct SStateDataMoveToPointEx final : public SStateDataMoveToPoint
{
...
struct SStateHideFromPoint final
{
    Fvector point;
...
struct SStateDataLookToPoint final
{
    Fvector point;
    u32 face_delay;
    SStateDataAction action;
...
struct SStateDataMoveAroundPoint final
{
    Fvector point;
    u32 vertex;
...
struct SStateDataActionLook final : public SStateDataAction
{
    Fvector point;
