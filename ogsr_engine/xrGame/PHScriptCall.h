...
class CPHScriptCondition final : public CPHCondition, public CPHReqComparerV
{
...
class CPHScriptAction final : public CPHAction, public CPHReqComparerV
{
...
class CPHScriptObjectCondition final : public CPHCondition, public CPHReqComparerV
{
...
public:
    ...
    [[nodiscard]] bool is_true() override;
    [[nodiscard]] bool obsolete() const override;
    [[nodiscard]] bool compare(const sol::object& v) const { return m_lua_object == v; }
    [[nodiscard]] bool compare(const CPHReqComparerV* v) const override { return v->compare(this); }
    [[nodiscard]] bool compare(const CPHScriptObjectCondition* v) const override;
};

class CPHScriptObjectAction final : public CPHAction, public CPHReqComparerV
{
...
class CPHScriptGameObjectCondition final : public CPHScriptObjectConditionN
{
...
public:
    ...
    [[nodiscard]] bool compare(const CObject* v) const { return m_obj->ID() == v->ID(); }
    [[nodiscard]] bool compare(const CPHReqComparerV* v) const override { return v->compare(this); }
    [[nodiscard]] bool obsolete() const override { return b_obsolete; }
};

class CPHScriptGameObjectAction final : public CPHScriptObjectActionN
{
...
class CPHSriptReqObjComparer final : public CPHReqComparerV
{
...
class CPHSriptReqGObjComparer final : public CPHReqComparerV
{
