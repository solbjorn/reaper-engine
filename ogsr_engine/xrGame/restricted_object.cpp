...
bool CRestrictedObject::accessible(const Fvector& position) const { return (accessible(position, EPS_L)); }
...
shared_str CRestrictedObject::in_restrictions() const { return (Level().space_restriction_manager().in_restrictions(object().ID())); }

shared_str CRestrictedObject::out_restrictions() const { return (Level().space_restriction_manager().out_restrictions(object().ID())); }

shared_str CRestrictedObject::base_in_restrictions() const { return (Level().space_restriction_manager().base_in_restrictions(object().ID())); }

shared_str CRestrictedObject::base_out_restrictions() const { return (Level().space_restriction_manager().base_out_restrictions(object().ID())); }
