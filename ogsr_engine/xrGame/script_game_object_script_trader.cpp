...
{
    xr::sol_set(lua, "set_trader_global_anim", &CScriptGameObject::set_trader_global_anim, "set_trader_head_anim", &CScriptGameObject::set_trader_head_anim, "set_trader_sound",
