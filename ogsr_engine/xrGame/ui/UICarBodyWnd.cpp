...
void CUICarBodyWnd::Show()
{
    ...
    {
        if (auto pActor = Actor(); pActor != nullptr)
            pActor->RepackAmmo();
    }
...
PIItem CUICarBodyWnd::CurrentIItem() { return m_pCurrentCellItem ? (PIItem)m_pCurrentCellItem->m_pData : nullptr; }
