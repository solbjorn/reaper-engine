...
void CUIButton::script_register(sol::state_view& lua)
{
    ...
    lua.new_usertype<CUI3tButton>("CUI3tButton", sol::no_constructor, sol::call_constructor, sol::constructors<CUI3tButton()>(), sol::base_classes, xr::sol_bases<CUI3tButton>());
