...
void CUIDialogWndEx::script_register(sol::state_view& lua)
{
    lua.new_usertype<CUIDialogWndEx>(
        "CUIScriptWnd", sol::no_constructor, sol::call_constructor, sol::factories(std::make_unique<CUIDialogWndEx>), "factory", &client_factory<CUIDialogWndEx>, "priv",
        &CUIDialogWndEx::priv, "ops", &CUIDialogWndEx::ops, "ON_KEYBOARD", sol::var(CUIDialogWndEx::ON_KEYBOARD), "AddCallback", &CUIDialogWndEx::AddCallback, "ClearCallbacks",
        &CUIDialogWndEx::ClearCallbacks, "Register",
        ...
        "Load", &CUIDialogWndEx::Load, sol::base_classes, xr_sol_bases<CUIDialogWndEx>());
}
