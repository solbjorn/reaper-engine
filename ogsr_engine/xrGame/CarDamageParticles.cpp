...
void CCarDamageParticles::Init(CCar* car)
{
    ...
    {
        m_car_damage_particles1._set(ini->r_string("damage_particles", "car_damage_particles1"));
        m_car_damage_particles2._set(ini->r_string("damage_particles", "car_damage_particles2"));
        m_wheels_damage_particles1._set(ini->r_string("damage_particles", "wheels_damage_particles1"));
        m_wheels_damage_particles2._set(ini->r_string("damage_particles", "wheels_damage_particles2"));
