...
{
    sol::state_view(L).new_usertype<CWeaponFN2000>("CWeaponFN2000", sol::no_constructor, sol::call_constructor, sol::factories(std::make_unique<CWeaponFN2000>), sol::base_classes,
