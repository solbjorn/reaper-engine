...
void CGameObject::save(NET_Packet&) {}
void CGameObject::load(IReader&) {}
...
void CGameObject::validate_ai_locations(bool decrement_reference)
{
    ...
    const u32 l_dwNewLevelVertexID = ai().level_graph().vertex_id(ai_location().level_vertex_id(), center);
