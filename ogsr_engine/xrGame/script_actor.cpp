...
void CScriptActor::script_register(sol::state_view& lua)
{
    lua.new_usertype<CActorCondition>(
        ...
        sol::property(&CActorCondition::GetMaxHealth, &set_max_health), "alcohol_health", &CActorCondition::m_fAlcohol, "alcohol_v",
        &CActorCondition::m_fV_Alcohol, "power_v", &CActorCondition::m_fV_Power, "satiety", &CActorCondition::m_fSatiety, "satiety_v",
        &CActorCondition::m_fV_Satiety, "satiety_health_v", &CActorCondition::m_fV_SatietyHealth, "satiety_power_v", &CActorCondition::m_fV_SatietyPower,

        "thirst", &CActorCondition::m_fThirst, "thirst_v", &CActorCondition::m_fV_Thirst, "thirst_health_v", &CActorCondition::m_fV_ThirstHealth,
        "thirst_power_v", &CActorCondition::m_fV_ThirstPower,

        "max_power_leak_speed", &CActorCondition::m_fPowerLeakSpeed, "jump_power", &CActorCondition::m_fJumpPower, "stand_power",
        &CActorCondition::m_fStandPower, "walk_power", &CActorCondition::m_fWalkPower, "jump_weight_power", &CActorCondition::m_fJumpWeightPower,
        "walk_weight_power", &CActorCondition::m_fWalkWeightPower, "overweight_walk_k", &CActorCondition::m_fOverweightWalkK, "overweight_jump_k",
        &CActorCondition::m_fOverweightJumpK, "accel_k", &CActorCondition::m_fAccelK, "sprint_k", &CActorCondition::m_fSprintK, "max_walk_weight",
        ...
        &CActorCondition::m_fCantWalkPowerBegin, "cant_walk_power_end", &CActorCondition::m_fCantWalkPowerEnd, "cant_spint_power_begin",
        &CActorCondition::m_fCantSprintPowerBegin, "cant_spint_power_end", &CActorCondition::m_fCantSprintPowerEnd, "limping_health_begin",
        &CActorCondition::m_fLimpingHealthBegin, "limping_health_end", &CActorCondition::m_fLimpingHealthEnd, "limping", sol::property(&IsLimping), "cant_walk",
        sol::property(&IsCantWalk), "cant_sprint", sol::property(&IsCantSprint), "radiation_v",
        sol::property(&get_change_v<&SConditionChangeV::m_fV_Radiation>, &set_change_v<&SConditionChangeV::m_fV_Radiation>), "psy_health_v",
        ...
        sol::property(&get_change_v<&SConditionChangeV::m_fV_HealthRestore>, &set_change_v<&SConditionChangeV::m_fV_HealthRestore>), "get_wound_size",
        &get_wound_size, "get_wound_total_size", &get_wound_total_size, sol::base_classes, xr::sol_bases<CActorCondition>());
    ...
    lua.new_usertype<CPHMovementControl>("CPHMovementControl", sol::no_constructor, "ph_mass", &CPHMovementControl::fMass, "crash_speed_max",
                                         &CPHMovementControl::fMaxCrashSpeed, "crash_speed_min", &CPHMovementControl::fMinCrashSpeed, "collision_damage_factor",
                                         &CPHMovementControl::fCollisionDamageFactor, "air_control_param", &CPHMovementControl::fAirControlParam,
                                         "jump_up_velocity", sol::property(&get_jump_up_velocity, &CPHMovementControl::SetJumpUpVelocity));

    lua.new_usertype<CActor>(
        "CActorBase", sol::no_constructor, "condition", sol::property(&get_actor_condition), "immunities", sol::property(&get_immunities), "hit_slowmo",
        ...
        "press_action", &press_action, "hold_action", &hold_action, "release_action", &CActor::IR_OnKeyboardRelease, "is_zoom_aiming_mode",
        &CActor::IsZoomAimingMode,
    ...
    lua.new_enum("EActorCameras", "eacFirstEye", ACTOR_DEFS::eacFirstEye, "eacLookAt", ACTOR_DEFS::eacLookAt, "eacFreeLook", ACTOR_DEFS::eacFreeLook,
                 "eacMaxCam", ACTOR_DEFS::eacMaxCam);

    lua.new_enum("inventory_slots", "KNIFE", KNIFE_SLOT, "FIRST_WEAPON", FIRST_WEAPON_SLOT, "SECOND_WEAPON", SECOND_WEAPON_SLOT, "GRENADE", GRENADE_SLOT,
                 "APPARATUS", APPARATUS_SLOT, "BOLT", BOLT_SLOT, "OUTFIT", OUTFIT_SLOT, "PDA", PDA_SLOT, "DETECTOR", DETECTOR_SLOT, "TORCH", TORCH_SLOT,
                 "HELMET", HELMET_SLOT, "NIGHT_VISION", NIGHT_VISION_SLOT, "BIODETECTOR", BIODETECTOR_SLOT, "TOTAL", SLOTS_TOTAL, "NO_ACTIVE", NO_ACTIVE_SLOT);
