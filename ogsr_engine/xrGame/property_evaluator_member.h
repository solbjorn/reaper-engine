...
{
    RTTI_DECLARE_TYPEINFO(CPropertyEvaluatorMember<_object_type>, CPropertyEvaluator<_object_type>);
...
public:
    explicit CPropertyEvaluatorMember(CPropertyStorage* storage, _condition_type condition_id, _value_type value, bool equality = true, LPCSTR evaluator_name = "");
    ~CPropertyEvaluatorMember() override = default;
