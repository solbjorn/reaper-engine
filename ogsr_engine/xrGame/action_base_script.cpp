...
void CActionBase<CScriptGameObject>::script_register(sol::state_view& lua)
{
    lua.new_usertype<CScriptActionBase>("action_base", sol::no_constructor, sol::call_constructor,
                                        ...
                                        "priv", &CScriptActionBase::priv, "ops", &CScriptActionBase::ops, "EXECUTE", sol::var(CScriptActionBase::action_ops::EXECUTE), "FINALIZE",
                                        sol::var(CScriptActionBase::action_ops::FINALIZE), "INITIALIZE", sol::var(CScriptActionBase::action_ops::INITIALIZE), "object",
