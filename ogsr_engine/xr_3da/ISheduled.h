...
public:
    ...
    [[nodiscard]] virtual f32 shedule_Scale() const = 0;
    ...
    [[nodiscard]] virtual shared_str shedule_Name() const { return shared_str{"unknown"}; }
    [[nodiscard]] virtual bool shedule_Needed() = 0;
};
