...
class IPhysicsGeometry : public virtual RTTI::Enable
{
...
class IPhysicsElement : public virtual RTTI::Enable
{
...
class IPhysicsShell : public virtual RTTI::Enable
{
...
class IObjectPhysicsCollision : public virtual RTTI::Enable
{
