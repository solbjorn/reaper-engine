...
{
    lua.new_usertype<IReader>("reader", sol::no_constructor, "r_seek", &IReader::seek, "r_tell", &IReader::tell, "r_vec3", &::r_fvector3, "r_bool", &::r_bool, "r_float",
                              &IReader::r_float, "r_u64", &IReader::r_u64, "r_s64", &IReader::r_s64, "r_u32", &IReader::r_u32, "r_s32", &IReader::r_s32, "r_u16", &IReader::r_u16,
                              "r_s16", &IReader::r_s16, "r_u8", &IReader::r_u8, "r_s8", &IReader::r_s8, "r_float_q16", &IReader::r_float_q16, "r_float_q8", &IReader::r_float_q8,
