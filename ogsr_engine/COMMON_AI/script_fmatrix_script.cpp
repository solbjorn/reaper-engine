...
void CScriptFmatrix::script_register(lua_State* L)
{
    module(L)[class_<Fmatrix>("matrix")
                  ...
                  .property("_14_", &Fmatrix::get_14, &Fmatrix::set_14)
                  .def_readwrite("j", &Fmatrix::j)
                  .property("_24_", &Fmatrix::get_24, &Fmatrix::set_24)
                  .def_readwrite("k", &Fmatrix::k)
                  .property("_34_", &Fmatrix::get_34, &Fmatrix::set_34)
                  .def_readwrite("c", &Fmatrix::c)
                  .property("_44_", &Fmatrix::get_44, &Fmatrix::set_44)
                  .def(constructor<>())
