...
class CPathManager<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type> final
    : public CPathManagerGeneric<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>
{
    RTTI_DECLARE_TYPEINFO(
        CPathManager<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>,
...
public:
    ...
    IC void setup(const _Graph* graph, _DataStorage* _data_storage, xr_vector<_edge_type>* _path, const _index_type& _start_node_index,
