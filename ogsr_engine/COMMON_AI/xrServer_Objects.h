...
// 46 - xrSE_ALifeObjectSearchLight		appended with property 'guid_bone', appended with property 'rotation_bone'
...
// 68 - CSE_ALifeHumanStalker, CSE_ALifeMonsterBase			new class appended, heritage changed
// 69 -	object broker changed from this version
//		CSE_ALifeObjectHangingLamp, CSE_ALifeHelicopter				heritage changed
...
// 97 - CSE_ALifeItemPDA				changed m_info_portion(int) to m_info_portion(shared_str) +m_specific_character +CSE_ALifeItemDocument m_wDoc (int->
// shared_str) 98 - CSE_ALifeItemPDA				changed m_info_portion(int) to m_info_portion(shared_str) +m_specific_character +CSE_ALifeItemDocument
// m_wDoc (int-> shared_str) 99 - CSE_ALifeObjectClimable			inheritance changed CSE_Abstruct -> CSE_AlifeObject 100 - CSE_ALifeObjectClimable
// inheritance changed CSE_AlifeObject -> CSE_AlifeDynamicObject 101 - CSE_ALifeCreaturePhantom		new class based on CSE_ALifeCreatureAbstract 102 -
// CSE_ALifeAnomalousZone			appended m_owner_id 103 - CSE_ALifeCustomZone			appended m_owner_id,removed from CSE_ALifeAnomalousZone 104 -
// CSE_Visual						appended flags 105 - CSE_ALifeTraderAbstract		added full name 106 - CSE_ALifeCustomZone			enabled\disabled
// time 107 - CSE_ALifeCustomZone			enabled\disabled time extended 108 - CSE_ALifeTraderAbstract		removed property m_tpEvents 109 -
// CSE_ALifeBaseMonster			added property m_spec_object 110 - CSE_ALifeHumanAbstract			removed a lot 111 - CSE_ALifeHumanStalker			removed
// demo mode 112 - CSE_Abstract					removed all the spawn properties, sad but true
...
//------------------------------------------------------------------------------
constexpr inline u16 SPAWN_VERSION{118};

class XR_NOVTABLE CSE_Shape : public ISE_Shape, public CShapeData
{
    RTTI_DECLARE_TYPEINFO(CSE_Shape, ISE_Shape, CShapeData);
...
public:
    ...
    void assign_shapes(CShapeData::shape_def* shapes, u32 cnt) override;
};
...
class CSE_PHSkeleton : public virtual RTTI::Enable
{
    RTTI_DECLARE_TYPEINFO(CSE_PHSkeleton);
