...
@set DEBUGCFLAGS=
@set LJCOMPILE=clang-cl /nologo /c /MP /O2 /Ob3 /Oi /Oy /Ot /GL -flto -fmerge-all-constants -fwhole-program-vtables /W4 /fp:precise /GF /GS- /arch:AVX2 /D_CRT_SECURE_NO_DEPRECATE /D_CRT_STDIO_INLINE=__declspec(dllexport)__inline
