...
#if !defined(BOOST_ASIO_HAS_IOCP_HIRES_TIMERS)
# if defined(BOOST_ASIO_HAS_IOCP)
#  if defined(BOOST_ASIO_WINDOWS) || defined(BOOST_ASIO_CYGWIN_W32_SOCKETS)
#   include <sdkddkver.h>
#   if defined(NTDDI_VERSION) && (NTDDI_VERSION >= NTDDI_WIN10_RS4)
#    if !defined(BOOST_ASIO_DISABLE_IOCP_HIRES_TIMERS)
#     define BOOST_ASIO_HAS_IOCP_HIRES_TIMERS 1
#    endif // !defined(BOOST_ASIO_DISABLE_IOCP_HIRES_TIMERS)
#   endif // defined(NTDDI_VERSION) && (NTDDI_VERSION >= NTDDI_WIN10_RS4)
#  endif // defined(BOOST_ASIO_WINDOWS) || defined(BOOST_ASIO_CYGWIN_W32_SOCKETS)
# endif // defined(BOOST_ASIO_HAS_IOCP)
#endif // !defined(BOOST_ASIO_HAS_IOCP_HIRES_TIMERS)
#if defined(BOOST_ASIO_HAS_IOCP_HIRES_TIMERS)
# define BOOST_ASIO_VERSION_TAG_s s
#else // defined(BOOST_ASIO_HAS_IOCP_HIRES_TIMERS)
# define BOOST_ASIO_VERSION_TAG_s
#endif // defined(BOOST_ASIO_HAS_IOCP_HIRES_TIMERS)
...
#  define BOOST_ASIO_VERSION_NAMESPACE \
  ...
  BOOST_ASIO_DETAIL_CAT(BOOST_ASIO_VERSION_TAG_r, \
  BOOST_ASIO_VERSION_TAG_s))))))))))))))))))))
