...
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -Wno-error=unused-command-line-argument /Zc:__cplusplus /MP /O2 /Ob2 /Oi /Oy /Ot /GL -march=haswell -mavx2 -mtune=native -flto -fmerge-all-constants -fwhole-program-vtables /W4 /GF /GS- /Zi /GT /D_WIN32_WINNT=0x0A00 -Xclang -fopenmp -Xclang -stdlib=libc++ /DNDEBUG /D_ITERATOR_DEBUG_LEVEL=0")
...
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} -Wno-error=unused-command-line-argument /Zc:__cplusplus /MP /O2 /Ob2 /Oi /Oy /Ot /GL -march=haswell -mavx2 -mtune=native -flto -fmerge-all-constants -fwhole-program-vtables /W4 /GF /GS- /Zi /GT /D_WIN32_WINNT=0x0A00 -Xclang -stdlib=libc++ /D_ITERATOR_DEBUG_LEVEL=2")
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -Wno-error=unused-command-line-argument /Zc:__cplusplus /MP /O2 /Ob2 /Oi /Oy /Ot /GL -march=haswell -mavx2 -mtune=native -flto -fmerge-all-constants -fwhole-program-vtables /W4 /GF /GS- /Zi /GT /D_WIN32_WINNT=0x0A00 -Xclang -stdlib=libc++ /D_ITERATOR_DEBUG_LEVEL=2")
