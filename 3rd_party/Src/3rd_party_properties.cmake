...
if(NOT LLVM_ENABLE_RUNTIMES)
  set(llvm_options "-Wno-error=unused-command-line-argument -march=haswell -mavx2 -flto -fmerge-all-constants -fwhole-program-vtables -Xclang -fopenmp")
else()
  set(llvm_options "-Wno-error=unused-command-line-argument -march=haswell -mavx2 -flto -fmerge-all-constants -fwhole-program-vtables")
endif()

set(conformance_options "/bigobj /permissive- /volatile:iso /Zc:inline /Zc:preprocessor /Zc:enumTypes /Zc:lambda /Zc:__cplusplus /Zc:externConstexpr /Zc:throwingNew /DNOMINMAX -fno-delayed-template-parsing -fstrict-aliasing -Wstrict-aliasing /D_CRT_STDIO_ISO_WIDE_SPECIFIERS -fno-ms-compatibility -fgnuc-version=0")
...
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} /D_WIN32_WINNT=0x0A00 /DNDEBUG /D_ITERATOR_DEBUG_LEVEL=0")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} $ENV{LIBCXX_OPTIONS} /D_WIN32_WINNT=0x0A00 /DNDEBUG /D_ITERATOR_DEBUG_LEVEL=0")
...
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} /D_WIN32_WINNT=0x0A00 /D_ITERATOR_DEBUG_LEVEL=2")
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} $ENV{LIBCXX_OPTIONS} /D_WIN32_WINNT=0x0A00 /D_ITERATOR_DEBUG_LEVEL=2")
