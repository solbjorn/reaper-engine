...
set(llvm_options "-march=skylake -mavx2 -flto -fmerge-all-constants -fforce-emit-vtables -fwhole-program-vtables -Xclang -fcoro-aligned-allocation")
...
if(LLVM_ENABLE_RUNTIMES)
  ...
  set(llvm_options "${llvm_options} -Xclang -fopenmp")
endif()
...
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /Gy /Gw /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} ${warning_options} /D_WIN32_WINNT=0x0A00 /D_MSVC_STL_HARDENING=1 /DNDEBUG /D_ITERATOR_DEBUG_LEVEL=0")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /Gy /Gw /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} $ENV{LIBCXX_OPTIONS} ${warning_options} /D_WIN32_WINNT=0x0A00 /D_MSVC_STL_HARDENING=1 /DNDEBUG /D_ITERATOR_DEBUG_LEVEL=0")
...
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /Gy /Gw /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} ${warning_options} /D_WIN32_WINNT=0x0A00 /D_MSVC_STL_HARDENING=1 /D_ITERATOR_DEBUG_LEVEL=2")
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /MP /O2 /Ob2 /Oi /Oy /Ot /GL /Gy /Gw /W4 /GF /GS- /Zi /GT ${conformance_options} ${llvm_options} $ENV{LIBCXX_OPTIONS} ${warning_options} /D_WIN32_WINNT=0x0A00 /D_MSVC_STL_HARDENING=1 /D_ITERATOR_DEBUG_LEVEL=2")
